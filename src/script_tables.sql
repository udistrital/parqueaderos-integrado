...
-- ddl-end --
COMMENT ON COLUMN public.propietario.documento IS 'Es la cedula, tarjeta de identidad seguido del numero ex CC10245032159 TI92100950407';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN public.vehiculo.placa IS 'Placa del vehiculo';
-- ddl-end --
