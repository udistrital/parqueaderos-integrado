...
-- Model Author: Jorge Useche, Leonardo Zambrano
...
-- ddl-end --
ALTER TABLE public.propietario OWNER TO olzambranop;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.vehiculo OWNER TO olzambranop;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.tipo_propietario OWNER TO olzambranop;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.isla OWNER TO olzambranop;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.grupo_isla OWNER TO olzambranop;
-- ddl-end --
