...
type Propietario struct {
	...
	Documento       string `orm:"column(documento);size(64);null"`
	PrimerNombre    string `orm:"column(primer_nombre);size(64);null"`
	SegundoNombre   string `orm:"column(segundo_nombre);size(64);null"`
	PrimerApellido  string `orm:"column(primer_apellido);size(64);null"`
	SegundoApellido string `orm:"column(segundo_apellido);size(64);null"`
}
